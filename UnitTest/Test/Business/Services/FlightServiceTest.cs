...
namespace NewShoreTest.Test.Business.Services
{
    ...
    public class FlightServiceTest
    {
        ...
        public void GetFlightsToDestinationTest()
        {
            ...
            Assert.AreEqual("MZL", flights[0].Origin);
            Assert.AreEqual("BCN", flights[1].Destination);
            Assert.IsNotNull(flights[0].Transport);
            Assert.AreEqual(700, (flights[0].Price + flights[1].Price));
